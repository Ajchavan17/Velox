...
interface Category {
    _id: string;
    name: string;
    type: 'income' | 'expense'; // Although type is number in User schema? No string.
...
export default function TransactionsPage() {
    ...
    useEffect(() => {
        if (searchParams?.get('new') === 'true') {
            setIsAdding(true);
            // Optional: Clean URL without refreshing
            // router.replace('/transactions', { scroll: false });
            // Keeping it might be useful if they refresh? Or better to clean it so it doesn't reopen.
            // Let's clean it nicely.
